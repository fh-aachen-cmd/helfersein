...
// SQL Query
$query = "INSERT INTO tl_members (id, organisation, firstname, lastname, street, postal, city, email, phone)
			   VALUES ('', '".$organisation."', '".$firstname."', '".$lastname."', '".$street."', '".$postal."', '".$city."', '".$email."', '".$phone."')";
