        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    ...
                    <form class="form-horizontal" action="mitglieder_speichern.php?action=neu" method="POST">
                        <div class="form-body">
                            <fieldset>
                            ...
                            <fieldset>
                                <legend><span>Oganisationszugehörigkeit</span></legend>

                                <div class="form-group">
                                    <?php include 'core/require.input_organisation.php'; ?>

                                    <label for="inputUser" class="col-sm-4 control-label">Organisation <span class="mandatory">*</span></label>
                                    <div class="col-sm-8">
                                        <?php
                                        /*
                                        foreach ($organisation as $org) {
                                            ...
                                            <div class="checkbox">
                                                <label>
                                                    <input type="checkbox" value="'. $org['id'] .'" name="Organisation"> '. $org['title'] .'
                                                </label>
                                            </div>';
                                        }
                                        */
                                        ...
                                        <div class="checkbox">
                                            <label>
                                                <input type="checkbox" value="DRK-Kreisverband Städteregion Aachen e.V." name="Organisation"> DRK-Kreisverband Städteregion Aachen e.V.
                                            </label>
                                        </div>
                                        <div class="checkbox">
                                            <label>
                                                <input type="checkbox" value="Malteser in Aachen" name="Organisation"> Malteser in Aachen
                                            </label>
                                        </div>
                                        <div class="checkbox">
                                            <label>
                                                <input type="checkbox" value="helfersein.de" name="Organisation"> helfersein.de
                                            </label>
                                        </div>
                                    </div>
                                </div>
